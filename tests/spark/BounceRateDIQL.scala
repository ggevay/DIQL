...
import de.tuberlin.dima.Util._
...
//    val grouped = visitsAll.groupByKey()
//
//    val res = grouped.map {case (gr, visits0) =>
//      val visits = visits0.toSeq
...
//
//    res.print()
//    //res.collect().sorted.toSeq.print()
